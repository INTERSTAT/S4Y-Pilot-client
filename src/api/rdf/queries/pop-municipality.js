export const populationFromMunicipality = ({ mun }) =>  `PREFIX qb: <http://purl.org/linked-data/cube#>
PREFIX sdmx-measure: <http://purl.org/linked-data/sdmx/2009/measure#>
PREFIX isc: <http://id.cef-interstat.eu/sc/>
PREFIX skos: <http://www.w3.org/2004/02/skos/core#>

SELECT DISTINCT ?municipality ?nuts3_Code (str(?nuts) as ?nuts3) ?lau_Code ?age ?gender ?population WHERE {
